    ...
    <View style={styles.container}>
      ...
      <View style={styles.cardContainer}>
        <View style={styles.row}>
          ...
          <LinearGradient colors={['#DEFFEE', '#91FFFC']} style={styles.gradientBackground}>
            <TouchableOpacity style={styles.touchableArea} onPress={() => navigation.navigate('WrongNoteScreen')}>
              <Text style={styles.cardTitleTopCenter}>오답 노트</Text>
              <Image source={require('../../assets/images/wrong.png')} style={styles.cardImageLeftBottom} />
            </TouchableOpacity>
          </LinearGradient>
        </View>
        <View style={styles.row}>
      ...
      >
        <Image source={require('../../assets/images/line.png')} style={styles.dragHandleImage} />
        <Image source={require('../../assets/images/line.png')} style={styles.dragHandleImage} />
        <Text style={styles.goalText}>오늘 목표까지 38개 남았어요!</Text>
        <View style={styles.progressContainer}>
          <Image source={require('../../assets/images/success.png')} style={styles.progressIcon} />
